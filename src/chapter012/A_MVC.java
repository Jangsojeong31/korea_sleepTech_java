...
/*
	...
	1) Model
		...
		- 상태 변경에 대해 View와 Controller에게 알릴 수 있는 매커니즘 제공
	...
	3) Controller 
		: 사용자의 입력을 처리하고 모델과 뷰 사이의 상호작용 관리
		- 사용자의 입력에 반응하여 모델을 업데이트하고, 필요한 경우 뷰를 새롭게 출력
		
			
	MVC 패턴의 장단점
		1) 장점
			- 역할 분담 : 각 구성요소가 독립적인 기능을 책임 -> 코드 관리 & 확장에 용이
			- 유지 보수에 용이 : 애플리케이션의 비즈니스 로직과 사용자 인터페이스(User Interface)가 분리되어 유지보수가 쉬움
		2) 단점
			- 복잡성 증가 : 간단한 애플리케이션 구현에는 MVC 패턴 구조가 복잡성 증가시킴
