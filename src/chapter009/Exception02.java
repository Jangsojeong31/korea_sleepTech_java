...
/*
 	...
 	1. try-catch 블록
 		- 기본 형태
 			...
 			- catch 불록 : 특정 예외 타입이 발생했을 때 실행될 코드를 정의
...
//		int division = 10 / 0; // 런타임 예외 
		...
		try {
			// 예외 발생 가능성 코드 작성
			int division = 10 / 0;
		} catch (ArithmeticException e) { // 예외 변수명 : e, exception이 주로 사용됨
...
//			int division = 10 / 0; // 1)
			...
			System.out.println("46번째 줄 주석 시 실행됨");
...
//			numbers[10] = 50;
			...
			System.out.println("배열 초과 인덱스 에러 : " + e.getMessage());
