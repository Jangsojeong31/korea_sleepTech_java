package chapter010.practice02;

import java.util.ArrayList;
import java.util.List;
import java.util.Scanner;

import chapter010.practice02.entity.Electronics;
import chapter010.practice02.entity.Furniture;
import chapter010.practice02.entity.Item;
import chapter010.practice02.repository.inMemoryItemRepository;
import chapter010.practice02.service.InventoryService;
import chapter010.practice02.service.InventoryServiceImpl;
 ...
 * - 사용 컬렉션 프레임워크
 * 		Set: 상품관리( 중복 방지)
 * 		Map: 카테코리별 상품 분류(Key: 카테고리명, value: 상품 목록)
 * - 추상 클래스
...
//		InventoryService inventoryService = new InventoryServiceImpl(repository); // 아래 코드와 동일 
		...
		while(true)	{
			...
			try {
				...
				switch(choice) {
				case 1: 
					addItem(inventoryService, sc);  // addItem은 아래에...
					break;
				case 2:
