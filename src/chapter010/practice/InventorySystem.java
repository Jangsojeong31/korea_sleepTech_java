	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			try {
				...
				// Integer.parseInt(A) : A 값을 분석하여 Integer 형태로 변경
				// >> 숫자 형태로 변경 불가한 값이 입력되는 경우 NumberFormatException 예외 발생
				...
				case 1:  // Add Book
					...
					manager.add(new Book(id, title, isbn, author, publisher,
							year, price, stock, category)); // 업캐스팅(Book -> Item)
					break;
				case 2:
					manager.listAll();
					break;
