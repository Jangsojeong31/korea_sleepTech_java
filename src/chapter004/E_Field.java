...
// >> 각 인스턴스마다 다른 값을 가질 수 있다. (같은 수도 있음)
...
// cf) JVM의 'Method Area'라고 불리는 영역에 저장됨 
...
class CarClass {
	...
	// 2) 클래스(정적) 필드: 클래스의 모든 객체가 동일한 값을 가짐
...
public class E_Field {
	public static void main(String[] args) {
		...
		car1.color = "black";
		//cf) 오류나지 않지만 사용하지 않음
		// car1.doorNumber = 10; //객체명으로 클래스 변수 접근 가능
