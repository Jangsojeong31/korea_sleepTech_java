...
//		StudentClass(name=이승아, age=30, grade=4.3)
//		StudentClass(name=이도경, age=32, grade=4.1)
//		StudentClass(name=이지훈, age=25, grade=4.0)
...
//		StudentClass(name=이민경, age=31, grade=3.5)
//		StudentClass(name=이지희, age=20, grade=3.8)
//		StudentClass(name=이지훈, age=25, grade=4.0)
//		StudentClass(name=이도경, age=32, grade=4.1)
//		StudentClass(name=이승아, age=30, grade=4.3)
